        ...
        return (
            <div>
                {topics && topics.map((topic) => (
                    <div key={topic.title}>
                        <h3 className='font-poppins text-lg font-medium my-1.5'>{topic.title}</h3>
                        <div>
                            {topic.subtopics.map((subtopic) => (
                                <p className='font-poppins text-sm font-extralight my-0.1 mx-1' key={subtopic.title}>{subtopic.title}</p>
                            ))}
                        </div>
                    </div>
                ))}
